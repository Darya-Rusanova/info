...
public class esperantoStemmer extends org.tartarus.snowball.SnowballStemmer {
    ...
    private final static Among[] a_9 = {
        ...
        new Among("e", -1, -1),
        new Among("i", -1, -1),
        new Among("j", -1, -1, "r_not_after_letter", methodObject),
        new Among("aj", 3, -1),
        new Among("oj", 3, -1),
        new Among("n", -1, -1, "r_not_after_letter", methodObject),
        new Among("an", 6, -1),
        new Among("en", 6, -1),
        new Among("jn", 6, -1, "r_not_after_letter", methodObject),
        new Among("ajn", 9, -1),
        new Among("ojn", 9, -1),
        new Among("on", 6, -1),
        new Among("o", -1, -1),
    ...
    private boolean r_not_after_letter() {
        lab0: {
            int v_1 = limit - cursor;
            lab1: {
                if (!(eq_s_b("-")))
